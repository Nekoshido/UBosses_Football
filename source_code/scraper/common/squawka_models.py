...
class Team(object):
    def __init__(self):
        ...
        self.goals_s_high_left_percent = 0
        self.goals_s_high_center_percent = 0
        self.goals_s_high_right_percent = 0
        self.goals_s_low_left_percent = 0
        self.goals_s_low_center_percent = 0
        self.goals_s_low_right_percent = 0
        self.goal_s_right = 0
        self.goal_s__left = 0
        self.goal_s__head = 0
        ...
        self.goals_c_high_left_percent = 0
        self.goals_c_high_center_percent = 0
        self.goals_c_high_right_percent = 0
        self.goals_c_low_left_percent = 0
        self.goals_c_low_center_percent = 0
        self.goals_c_low_right_percent = 0
        self.goal_c_right = 0
        self.goal_c__left = 0
        self.goal_c__head = 0
        ...
        self.shot_accuracy_position = []
        self.total_chances_created = 0
        self.assist = 0
        self.key_passes = 0
        self.tt_chan_pitch = []
        self.possession = 0
